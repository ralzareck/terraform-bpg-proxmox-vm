...
The 01-basic-clone example uses the terraform-bgp-proxmox-vm module to deploy a single Virtual Machine to a proxmox server using a another VM as base. The cloned VM can (and should) be a Proxmox Template VM.

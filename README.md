...
| <a name="input_vm_start"></a> [vm\_start](#input\_vm\_start) | The start settings of the VM. | <pre>object({<br/>    on\_deploy  = bool<br/>    on\_boot    = bool<br/>    order      = optional(number, 0)<br/>    up\_delay   = optional(number, 0)<br/>    down\_delay = optional(number, 0)<br/>  })</pre> | <pre>{<br/>  "down\_delay": 0,<br/>  "on\_boot": true,<br/>  "on\_deploy": true,<br/>  "order": 0,<br/>  "up\_delay": 0<br/>}</pre> | **no** |
| <a name="input_vm_agent"></a> [vm\_agent](#input\_vm\_agent) | The QEMU guest agent settings of the VM | <pre>object({<br/>    enabled   = optional(bool, false)<br/>    type      = optional(string, "virtio")<br/>    wait\_ipv4 = optional(bool, false)<br/>    wait\_ipv6 = optional(bool, false)<br/>  })</pre> | `null` | **no** |
